<template>
  <div style="background:#fff;margin:8px;">
    <ul class="title">
      <li><span class="xianshigou">限时购</span></li>
      <li><ul class="daojishi">
        <li>{{h}}</li>
        <li>:</li>
        <li>{{m}}</li>
        <li>:</li>
      ...
      <li style="margin-bottom:0;"><span class="fangyi">防疫商品 每日10点更新</span></li>
    </ul>
    <ul>
    ...
    <ul class="bottom">
      <li v-for="(item,i) of bottomlist" :key="i">
        ...
        <div>
          <div v-for="(s,i) of item.src" :key="i"><img :src="s.src" alt=""></div>
        </div>
      </li>
    </ul>
  </div>
...
export default {
  data(){
    return {
      ...
      s:0,
      list:[
        {src:require('../assets/shopping/third/xianshi01.png'),oldprice:218,price:128},
        {src:require('../assets/shopping/third/xianshi02.png'),oldprice:346,price:198},
        {src:require('../assets/shopping/third/xianshi03.png'),oldprice:266,price:98},
        {src:require('../assets/shopping/third/xianshi04.png'),oldprice:198,price:108}
      ],
      bottomlist:[
