<template>
  <div class="bodyAll">
    ...
    <div class="bodyg">
      <div class="b1">
        <img src="../../../assets/官方.png" alt width="25px" />
      </div>
    ...
    <div class="bodyh">
      ...
      <div class="h4">
        <div>
          <img src="../../../assets/心愿单.png" alt width="30px" />
        </div>
        <div>心愿单</div>
      </div>
    </div>
    ...
    <div class="bodyk">
      ...
      <div class="k1">
        <div>
          <img src="../../../assets/gou1.jpg" alt width="20px" />
          <span class="k3">7天保价</span>
        </div>
        <div class="k2">
          <div>领航奉献旗舰店发货</div>
          <div>
      ...
      <div class="k5">
        <img src="../../../assets/进入.png" alt width="25px" />
      </div>
    </div>
    <!-- 灰色背景 -->
    <div class="back"></div>
    ...
    <div class="back"></div>
    <div class="bodym">
      <img src="../../../assets/lkzcjp.jpg" alt width="100%" />
    </div>
  </div>
</template>
<script>
